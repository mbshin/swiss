...
> 트레킹/체르마트·크랑몬타나·에비앙박 일정 폐기, 골프 + 미식 + 호숫가 도시 중심 재구성. 7/10 AI For Good 컨퍼런스 마지막날 참석은 유지. 이동은 모두 **오전 라운드 후 오후** 패턴. 스위스 라운드 0회 + 스위스 박은 제네바 2박만.
...
| 4 | 7/7 (화) | 🇦🇹→🇫🇷 | 인스부르크 → 안시 | 오전 **R3: Innsbruck-Igls** + 오후 이동(6h) |
| 5 | 7/8 (수) | 🇫🇷 프랑스 | 안시 ↔ 메제브 | **R4: Megève GC 데이트립** (왕복 2h) |
| 6 | 7/9 (목) | 🇫🇷→🇨🇭 | 안시 → 에비앙 → 제네바 | 오전 **R5: Évian Resort** + 오후 제네바 이동 |
...
### Day 4 (7/7 화) — R3: Innsbruck-Igls · 안시 직행 이동

| 항목 | 내용 |
| --- | --- |
| **국가** | 🇦🇹 오스트리아 → 🇨🇭(통과) → 🇫🇷 프랑스 |
| **오전** | 06:30 제펠트 출발 → 07:00 인스부르크-Igls 도착 → 07:30 티오프 |
| **라운드** | **GC Innsbruck-Igls (Lans)** — Donald Harradine 디자인 par 71 |
| **그린피** | €90-110 |
| **오후 이동** | 12:30 라운드 종료 → 13:30 출발 → 19:30경 안시 도착 |
| **운전** | 인스부르크 → 안시 약 580km, 6시간 (A12·A1·A40, 베른·로잔·제네바 경유) |
| **저녁** | Brasserie des Européens 또는 Le Bilboquet (호숫가 가벼운 저녁) |
...
| **오후** | 안시 구시가지(Vieille Ville) 산책 · 안시 호숫가 자전거 · 사랑의 다리 |
...
> **이동 룰**: 7/5(2.5h)·7/7(6h)·7/9(1h+50분) 모두 오전 라운드 → 점심 → 오후 운전 패턴.
> **스위스 라운드 0회**: 크랑몬타나 제외하여 스위스 박·비용 모두 최소화. 골프는 오스트리아 3 + 프랑스 2.
...
| 참석 일정 | **7/10 (금) 마지막날만 참석** (7/5~9는 골프 라운드) |
...
> 1인 부담분 = 룸 합계 ÷ 2. 스위스 박은 제네바 2박만 + 안시 호수 뷰 호텔 = 미식·풍경·동선 균형.
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| **가성비형** | ₩130만 | ₩45만 | ₩53만 | ₩99만 | ₩60만 | ₩15만 | **~₩402만** |
| **표준형** | ₩150만 | ₩55만 | ₩73만 | ₩99만 | ₩80만 | ₩30만 | **~₩487만** |
| **고급형 (안시 미슐랭 포함)** | ₩180만 | ₩65만 | ₩100만 | ₩115만 | ₩130만 | ₩50만 | **~₩640만** |

> 해외연수 최대 지원 600만원 기준: 가성비형·표준형 충분히 지원금 내. v3 5라운드(크랑) 안 대비 1인당 ~₩50만 절감.
...
- [ ] **7/7 빡빡**: 오전 라운드 + 오후 6시간 운전 → 인스부르크 06:30 출발 + 휴게소 2~3회
- [ ] **7/8 데이트립**: 안시 06:30 출발 → 메제브 왕복 2시간 + 라운드 → 안시 오후 휴식 (Évian 베이스 대비 1h 절감)
...
- [ ] **날씨**: 알프스 7월 오후 천둥번개 → 오전 티타임 우선 (5라운드 모두 오전 티오프)
